...
- (void)viewDidLoad
{
    ...
    downloadModel.url = @"http://video.lincoo.net/1073ht/video/20160425/160425162023244113619.mp4";
    ...
    DownloadModel *downloadModel02 = [[DownloadModel alloc] init];
    downloadModel02.name = @"333";
    downloadModel02.url = @"http://video.lincoo.net/1056htcfsy/video/20160309/160309235012828162609.mp4";
    
    self.downloadModels = [NSMutableArray arrayWithArray:@[downloadModel,downloadModel01,downloadModel02]];
